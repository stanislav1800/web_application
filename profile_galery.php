            ...
            <div class="content_left">
                ...
                <ul class="ulli">
                    ...
                    <li class="list-group-item active">
                        <a href="profile_galery.php" style="color: white">
            ...
            <div class="profile-body">
                <h1>Фото:</h1>
                    ...
                    foreach ($products as $product){
                        ?>
                            <div class="foto_body">
                            <img  src="<?=$product[2] ?>" alt="Snow" style="width:100%">
                                <button class="foto_button" onclick="window.location.href = '/vendor/delete_foto.php?id=<?=$product[0] ?>&fail=<?=$product[2] ?>';">X</button>
                            </div>
                        <?php
                    }
                    ?>
                <form id="myform" class="galery" action="vendor/add_foto.php" method="post" enctype="multipart/form-data">
